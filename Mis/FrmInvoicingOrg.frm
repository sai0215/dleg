...
Begin VB.Form frmInvoicingOrg 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.OptionButton OptMonth 
            BackColor       =   &H00C0C0C0&
            Caption         =   "&Month"
            DisabledPicture =   "FrmInvoicingOrg.frx":0000
            DragIcon        =   "FrmInvoicingOrg.frx":0442
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   9.75
               Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmInvoicingOrg"
...
Dim j As Integer
    ...
    Sqlqry1 = "select * from bo_mas Where STATUS='N' AND media='" & CboMedia.Text & "' and invoice_Date Between #" & Format(FirstDate, "mm-dd-yyyy") & "# and #" & Format(LastDate, "mm-dd-yyyy") & "# order by media"
    Set rs = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
