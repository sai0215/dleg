...
Begin VB.Form frmBO1 
   ...
   Begin VB.CommandButton cmdAdd 
      BackColor       =   &H00C0FFC0&
      Caption         =   "&Add"
      DisabledPicture =   "frmBO1.frx":0306
      DownPicture     =   "frmBO1.frx":0838
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
  ...
  ElseIf Mid(Trim(cboMediatype.Text), 1, 3) = "Cin" Then
   If MSFlexcin.Rows > 1 Then
    ...
    Sqlqry = " Insert into Bo_Mas values('" & Val(lblserialno.Caption) & "','" & Format(txtdate.TextWithMask, "dd/mm/yyyy") & "','" & Trim(cboCurrency.Text) & "'," & Val(txtConvRate) & "," & Val(Trim(txtGrAmountCin.Text)) & "," & Val(Trim(txtNetAmountCin.Text)) & ",'" & cboyear.Text & "','" _
                                     ...
                                     & findfirstfixup(cboProduct.Text) & "','" _
                                     & findfirstfixup(lblClientName.Caption) & "','" _
                                     & findfirstfixup(lblAgencyName.Caption) & "','Cinema','Cinema','" _
                                     & findfirstfixup(Trim(txtboref.Text)) & "'," _
...
Private Sub txtamountcin_LostFocus()
  ...
  If ValidateData = True Then
   ...
   If IsNumeric(txtamountcin.Text) = False Then
...
Private Sub txtrateol_LostFocus()
  If ValidateData = True Then
   ...
   If txtimpression.Text = "" Or IsNumeric(txtimpression.Text) = False Then
     MsgBox " Invalid Impressions", vbInformation, "Invalid Entry"
     txtimpression.SetFocus
     Exit Sub
   End If
   
   If txtrateol.Text = "" Or IsNumeric(txtrateol.Text) = False Then
   ...
   i = MsgBox(" Are you sure .. ! You want to Remove this transaction", vbInformation + vbYesNo)
    If i = vbYes Then
     With MSFlexmag
        ...
        Sqlqry1 = "Select * from dumBo_TRAmagbo where serial_no='" & Val(lblserialno.Caption) & "' and Issue_no ='" & Trim(txtissueno) & "' and Page ='" & Trim(txtPage) & "' and space='" & Trim(cbospace.Text) & "' and tra_amount =" & Val(txtamountmag) & ""
        Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
        If rs1.RecordCount <> 0 Then
        rs1.MoveFirst
        Sqlqry2 = "delete * from dumBo_TRAmagbo"
        ws.BeginTrans
        db.Execute Sqlqry2
        ws.CommitTrans
        End If
...
Private Sub txtamountmag_LostFocus()
   ...
   If IsNumeric(txtamountmag.Text) = False Then
      MsgBox "Invalid Amount", vbInformation, "Invalid Entry"
    ...
    If rs.RecordCount = 0 Then
       ...
       Sqlqry1 = " Insert into dumBo_TRAmagbo values('" & Val(lblserialno.Caption) & "','" & cboyear.Text & "','" _
        ...
        Else
            ...
            rs.MoveFirst
            Do Until rs.EOF
              MSFlexmag.AddItem rs!Issue_no & Chr(9) & rs!Page & Chr(9) & rs!Space & Chr(9) & rs!Description & Chr(9) & rs!mat_code & Chr(9) & rs!Type & Chr(9) & rs!tra_amount
              rs.MoveNext
            Loop
        End If
   ...
   i = MsgBox(" Are you sure .. ! You want to Remove this transaction", vbInformation + vbYesNo)
    If i = vbYes Then
     With MSFlexcin
        ...
        Sqlqry1 = "select * from dumBo_TRAcinbo where serial_no='" & Val(lblserialno.Caption) & "' and description ='" & Trim(txtDesccin) & "' and Day ='" & Trim(cbodaycin) & "' and Length ='" & Trim(cbolength) & "' and tra_amount =" & Val(txtamountcin) & ""
        Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
        If rs1.RecordCount <> 0 Then
        rs1.MoveFirst
        Sqlqry2 = "delete * from dumBo_TRAcinbo"
        ws.BeginTrans
        db.Execute Sqlqry2
        ws.CommitTrans
        End If
  ...
  i = MsgBox(" Are you sure .. ! You want to Remove this transaction", vbInformation + vbYesNo)
   If i = vbYes Then
    With MSFlextv
        ...
        Sqlqry1 = "select * from dumBo_TRAtvbo where serial_no='" & Val(lblserialno.Caption) & "' and description ='" & Trim(txtdesctv) & "' and Day ='" & Trim(txtDaytv) & "' and Time ='" & Trim(PVMaskTime.TextWithMask) & "' and tra_amount =" & Val(txtamounttv) & ""
        Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
        If rs1.RecordCount <> 0 Then
        rs1.MoveFirst
        Sqlqry2 = "delete * from dumBo_TRAtvbo"
        ws.BeginTrans
        db.Execute Sqlqry2
        ws.CommitTrans
        End If
  ...
  i = MsgBox(" Are you sure .. ! You want to Remove this transaction", vbInformation + vbYesNo)
   If i = vbYes Then
    With MSFlexol
        ...
        Sqlqry1 = "select * from dumBo_TRAolbo where serial_no='" & Trim(lblserialno.Caption) & "' and description ='" & Trim(txtdescol) & "' and date_from=#" & Format(txtdatefrom.TextWithMask, "dd/mm/yyyy") & "# and mat_code ='" & findfirstfixup(Trim(cbomatol.Text)) & "' and tra_amount =" & Val(txtamountol) & ""
        Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
        If rs1.RecordCount <> 0 Then
         rs1.MoveLast
         'Sqlqry2 = "Delete * from dumBo_TRAolbo where serial_no='" & Trim(lblserialno.Caption) & "' and description ='" & Trim(txtdescol) & "' and date_from=#" & Format(txtdatefrom.TextWithMask, "dd/mm/yyyy") & "# and mat_code ='" & findfirstfixup(Trim(cbomatol.Text)) & "' and tra_amount =" & Val(txtamountol) & ""
          Sqlqry2 = "Delete  from dumBo_TRAolbo"
            ws.BeginTrans
            db.Execute Sqlqry2
            ws.CommitTrans
        End If
