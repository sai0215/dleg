...
Begin VB.Form frmBOMod 
   BackColor       =   &H00FFFFFF&
   Caption         =   "BOModification"
   ClientHeight    =   8685
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   ...
   Begin VB.CommandButton cmdModify 
      BackColor       =   &H00C0FFC0&
      Caption         =   "&Modify"
      DisabledPicture =   "frmBOMod.frx":0748
      DownPicture     =   "frmBOMod.frx":0C7A
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
...
Sqlqry = "Select * from Bo_Mas where status='N' ORDER BY val(Serial_NO)"
