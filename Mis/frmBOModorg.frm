...
Begin VB.Form frmBOModOrg 
   ...
   Begin VB.CommandButton cmdModify 
      BackColor       =   &H00C0FFC0&
      Caption         =   "&Modify"
      DisabledPicture =   "frmBOModorg.frx":0748
      DownPicture     =   "frmBOModorg.frx":0C7A
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
...
Private Sub cboProduct_Click()
 ...
 lblClientName.Caption = ""
    ...
    Set rs = db.OpenRecordset(Sqlqry, dbOpenDynaset)
    If rs.RecordCount <> 0 Then
        lblAgencyName.Caption = rs!Agent_name
        ...
        lblClientName.Caption = rs!client_name
    End If
   cboMattv.Clear
   cbomatmag.Clear
   cboMatCin.Clear
   cbomatol.Clear
    ...
    If rs1.RecordCount <> 0 Then
            ...
            cbomatol.Clear
                ...
                Do Until rs1.EOF
                 cboMattv.AddItem rs1!code & " " & rs1!Name
                 cboMatCin.AddItem rs1!code & " " & rs1!Name
                 cbomatmag.AddItem rs1!code & " " & rs1!Name
                 cbomatol.AddItem rs1!code & " " & rs1!Name
                 rs1.MoveNext
                Loop
              '  txtboref.SetFocus
    End If
...
ElseIf Mid(CboSmedia, 1, 3) = "Cin" Then
   lblviewMedia.Caption = "Cinema"
   LblviewSubmedia.Caption = Trim(Mid(cboMediatype, 8, 30))
ElseIf Mid(CboSmedia, 1, 3) = "Mag" Then
   lblviewMedia.Caption = "Magazine"
   LblviewSubmedia.Caption = Trim(Mid(cboMediatype, 10, 30))
ElseIf Mid(CboSmedia, 1, 3) = "Onl" Then
   lblviewMedia.Caption = "Online"
   LblviewSubmedia.Caption = Trim(Mid(cboMediatype, 8, 30))
ElseIf Mid(CboSmedia, 1, 3) = "Tel" Then
   lblviewMedia.Caption = "Television"
   LblviewSubmedia.Caption = Trim(Mid(cboMediatype, 12, 30))
End If
...
If ValidateData = True Then
   ...
   If Mid(cboMediatype, 1, 3) = "Tel" Then
       ...
       Sqlqry = "Update Bo_Mas set TDATE=#" & Format(txtdate.TextWithMask, "dd/mm/yyyy") & "#," & _
                            ...
                            " Region ='" & Trim(txtregion) & "'," & _
                            " boremarks ='" & Trim(txtremarks) & "'," & _
                            " Product ='" & findfirstfixup(Trim(cboProduct.Text)) & "'," & _
                            " client='" & findfirstfixup(Trim(lblClientName)) & "'," & _
                            " Agency='" & findfirstfixup(Trim(lblAgencyName)) & "'," & _
                            " Media ='Television'," & _
                            " Sub_Media='" & Mid(cboMediatype, 13, 30) & "'," & _
      ...
      .Col = 7
        acamount = .Text
           ...
           Sqlqry2 = " Insert into Bo_TRAtv values('" & Val(lstVoucNo.Text) & "','" & cboyear.Text & "','" _
                                     ...
                                     & findfirstfixup(lblClientName.Caption) & "','" _
                                     & findfirstfixup(lblAgencyName.Caption) & "','Television','" _
                                     & Mid(cboMediatype, 12, 30) & "','" _
  ...
  ElseIf Mid(cboMediatype, 1, 3) = "Mag" Then
       ...
       Sqlqry = "Update Bo_Mas set TDATE=#" & Format(txtdate.TextWithMask, "dd/mm/yyyy") & "#," & _
                            ...
                            " Agency='" & findfirstfixup(Trim(lblAgencyName)) & "'," & _
                            " Media ='Magazine'," & _
                            " Sub_Media='" & Mid(cboMediatype, 11, 30) & "'," & _
                            " Bo_ref ='" & findfirstfixup(Trim(txtboref)) & "', " & _
     ...
     For B = 1 To a - 1
      ...
      .Col = 7
        acamount = .Text
           ...
           Sqlqry2 = " Insert into Bo_TRAmag values('" & Val(lstVoucNo.Text) & "','" & cboyear.Text & "','" _
                                     & cbomonth.Text & "'," & Val(cbomonth.ListIndex) & ",'" _
                                     & findfirstfixup(cboProduct.Text) & "','" _
                                     & findfirstfixup(lblClientName.Caption) & "','" _
                                     & findfirstfixup(lblAgencyName.Caption) & "','Magazine','" _
                                     & Mid(cboMediatype, 10, 30) & "','" _
                                     & findfirstfixup(Trim(txtboref.Text)) & "','" _
                                     & acissue & "','" _
                                     & Format(acissdate, "dd/mm/yyyy") & "','" _
                                     & acpage & "','" _
                                     & findfirstfixup(Trim(acdesc)) & "','" _
                                     & findfirstfixup(Trim(acmat)) & "','" _
                                     & acspace & "','" _
                                     & acptype & "','" _
                                     & Trim(cboCurrency.Text) & "'," _
                                     & Val(txtConvRate.Text) & "," _
                                     & acamount & ", " & Val(acamount) * Val(txtConvRate.Text) & ")"
  ...
  ElseIf Mid(cboMediatype, 1, 3) = "Cin" Then
     ...
     For B = 1 To a - 1
      ...
      .Col = 6
        acamount = .Text
           ...
           Sqlqry2 = " Insert into Bo_TRAcin values('" & Val(lstVoucNo.Text) & "','" & cboyear.Text & "','" _
                                     & cbomonth.Text & "','" _
                                     & findfirstfixup(cboProduct.Text) & "','" _
                                     & findfirstfixup(lblClientName.Caption) & "','" _
                                     & findfirstfixup(lblAgencyName.Caption) & "','Cinema','" _
                                     & acsubmedia & "','" _
                                     & findfirstfixup(Trim(txtboref.Text)) & "','" _
                                     & acday & "','" _
                                     & acsec & "','" _
   ...
   Else
       ...
       Sqlqry = "Update Bo_Mas set TDATE=#" & Format(txtdate.TextWithMask, "dd/mm/yyyy") & "#," & _
                            ...
                            " Agency='" & findfirstfixup(Trim(lblAgencyName)) & "'," & _
                            " Media ='Online'," & _
                            " Sub_Media='" & Mid(cboMediatype, 9, 30) & "'," & _
                            " Bo_ref ='" & findfirstfixup(Trim(txtboref)) & "', " & _
       ...
       .Col = 7
        acamount = .Text
           ...
           Sqlqry2 = " Insert into Bo_TRAol values('" & Val(lstVoucNo.Text) & "','" & Format(acdtfrom, "dd/mm/yyyy") & "','" & Format(acdtto, "dd/mm/yyyy") & "','" & cboyear.Text & "','" _
                                     ...
                                     & findfirstfixup(cboProduct.Text) & "','" _
                                     & findfirstfixup(lblClientName.Caption) & "','" _
                                     & findfirstfixup(lblAgencyName.Caption) & "','Online','" _
                                     & Mid(cboMediatype, 8, 30) & "','" _
                                     & findfirstfixup(Trim(txtboref.Text)) & "','" _
                                     & findfirstfixup(Trim(acdesc)) & "','" _
                                     & findfirstfixup(acmat) & "','" _
                                     & acptype & "'," _
     ...
     If CboSAgency.Text = "All" And CboSProduct.Text = "All" Then
        ...
        Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
             If rs1.RecordCount <> 0 Then
                ...
                Set ws = DBEngine.Workspaces(0)
                Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
                MSFlexview.AddItem rs1!serial_no & Chr(9) & rs1!Agency & Chr(9) & rs1!Product & Chr(9) & rs1!sub_media & Chr(9) & rs1!Day & Chr(9) & rs1!Length & Chr(9) & rs1!Description & Chr(9) & rs1!mat_code & Chr(9) & rs1!Type & Chr(9) & rs1!tra_amount
                   rs1.MoveNext
                   Loop
             End If
        ElseIf CboSAgency.Text = o And CboSProduct.Text = "All" Then
     ...
     If CboSAgency.Text = "All" And CboSProduct.Text = "All" Then
        ...
        Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
             If rs1.RecordCount <> 0 Then
                ...
                Set ws = DBEngine.Workspaces(0)
                Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
                  MSFlexview.AddItem rs1!serial_no & Chr(9) & rs1!Agency & Chr(9) & rs1!Product & Chr(9) & rs1!Day & Chr(9) & rs1!Time & Chr(9) & rs1!Description & Chr(9) & rs1!mat_code & Chr(9) & rs1!Type & Chr(9) & rs1!spots & Chr(9) & rs1!Rate & Chr(9) & rs1!tra_amount
                   rs1.MoveNext
                   Loop
             End If
        ElseIf CboSAgency.Text = o And CboSProduct.Text = "All" Then
...
Private Sub populateproducts()
 ...
 Private Sub Populateissuenos()
    ...
    Set ws = DBEngine.Workspaces(0)
    Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
    Sqlqry = "Select distinct(issue_no) from bo_tramag Order by issue_no"
    Set rs = db.OpenRecordset(Sqlqry, dbOpenDynaset)
    If rs.RecordCount = 0 Then
         Exit Sub
    Else
    ...
    i = Val(lstVoucNo.Text)
        ...
        Set rs2 = db.OpenRecordset(Sqlqry2, dbOpenDynaset)
         If rs2.RecordCount <> 0 Then
           ...
           lblAgencyName.Caption = rs2!Agency
           lblClientName.Caption = rs2!client
           ...
           If rs2!media = "Television" Then
            ...
            ws.CommitTrans
                    ...
                    MSFlextv.AddItem rs1!Day & Chr(9) & rs1!Time & Chr(9) & rs1!Description & Chr(9) & rs1!mat_code & Chr(9) & rs1!Type & Chr(9) & rs1!spots & Chr(9) & rs1!Rate & Chr(9) & rs1!tra_amount
                    rs1.MoveNext
                   Loop
                   txtDaytv.SetFocus
               End If
...
'               cboMediaType.Text = "Cinema"
               ...
               If rs1.RecordCount <> 0 Then
                   ...
                   Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
                    ...
                    MSFlexcin.AddItem rs1!sub_media & Chr(9) & rs1!Day & Chr(9) & rs1!Length & Chr(9) & rs1!Description & Chr(9) & rs1!mat_code & Chr(9) & rs1!Type & Chr(9) & rs1!tra_amount
                    rs1.MoveNext
                   Loop
               ...
               If rs1.RecordCount <> 0 Then
                  ...
                  rs1.MoveFirst
                   Do Until rs1.EOF
                    ...
                    MSFlexmag.AddItem rs1!issue_no & Chr(9) & Format(rs1!tdate, "dd/mm/yyyy") & Chr(9) & rs1!Page & Chr(9) & rs1!Space & Chr(9) & rs1!Description & Chr(9) & rs1!mat_code & Chr(9) & rs1!Type & Chr(9) & rs1!tra_amount
                    rs1.MoveNext
                   Loop
                   txtissueno.SetFocus
                End If
           ...
           cboProduct.Text = Trim(rs2!Product)
...
Private Sub txtamountcin_LostFocus()
  ...
  If ValidateData = True Then
   ...
   If cboMatCin.Text = "" Then
      MsgBox "Invalid Material", vbInformation, "Invalid Entry"
      cboMatCin.SetFocus
      Exit Sub
   End If
     ...
     If rs.RecordCount = 0 Then
       Sqlqry1 = " Insert into dumBo_TRAcinbo values('" & Val(lstVoucNo) & "','" & cboyear.Text & "','" _
        ...
        Else
            ...
            rs.MoveFirst
            Do Until rs.EOF
              MSFlexcin.AddItem rs!sub_media & Chr(9) & rs!Day & Chr(9) & rs!Length & Chr(9) & rs!Description & Chr(9) & rs!mat_code & Chr(9) & rs!Type & Chr(9) & rs!tra_amount
              rs.MoveNext
            Loop
        End If
   ...
   i = MsgBox(" Are you sure .. ! You want to Remove this transaction", vbInformation + vbYesNo)
    If i = vbYes Then
     With MSFlexmag
        ...
        Sqlqry1 = "Select * from dumBo_TRAmagbo where serial_no='" & Val(lstVoucNo.Text) & "' and Issue_no ='" & Trim(txtissueno) & "' and Page ='" & Trim(txtPage) & "' and space='" & Trim(cbospace.Text) & "' and tdate = #" & Format(txtissdate.TextWithMask, "dd/mm/yyyy") & "# and tra_amount =" & Val(txtamountmag) & ""
        Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
        If rs1.RecordCount <> 0 Then
        rs1.MoveLast
        rs1.Delete
    ...
    If rs.RecordCount = 0 Then
       ...
       Sqlqry1 = " Insert into dumBo_TRAmagbo values('" & Val(lstVoucNo) & "','" & cboyear.Text & "','" _
        ...
        Else
            ...
            rs.MoveFirst
            Do Until rs.EOF
              MSFlexmag.AddItem rs!issue_no & Chr(9) & rs!tdate & Chr(9) & rs!Page & Chr(9) & rs!Space & Chr(9) & rs!Description & Chr(9) & rs!mat_code & Chr(9) & rs!Type & Chr(9) & rs!tra_amount
              rs.MoveNext
            Loop
        End If
   ...
   i = MsgBox(" Are you sure .. ! You want to Remove this transaction", vbInformation + vbYesNo)
    If i = vbYes Then
     With MSFlexcin
        ...
        Sqlqry1 = "select * from dumBo_TRAcinbo where serial_no='" & Val(lstVoucNo) & "' and description ='" & Trim(txtDesccin) & "' and Day ='" & Trim(cbodaycin) & "' and Length ='" & Trim(cbolength) & "' and tra_amount =" & Val(txtamountcin) & ""
        Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
        If rs1.RecordCount <> 0 Then
        rs1.MoveLast
        rs1.Delete
  ...
  i = MsgBox(" Are you sure .. ! You want to Remove this transaction", vbInformation + vbYesNo)
   If i = vbYes Then
    With MSFlextv
        ...
        Sqlqry1 = "select * from dumBo_TRAtvbo where serial_no='" & Val(lstVoucNo) & "' and description ='" & Trim(txtdesctv) & "' and Day ='" & Trim(txtDaytv) & "' and Time ='" & Trim(PVMaskTime.TextWithMask) & "' and tra_amount =" & Val(txtamounttv) & ""
        Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
        If rs1.RecordCount <> 0 Then
        rs1.MoveLast
        rs1.Delete
