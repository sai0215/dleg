...
Begin VB.Form frmBankPaymentModification 
   BackColor       =   &H00FFFFC0&
   Caption         =   "Bank Payment Modification"
   ClientHeight    =   8775
   ClientLeft      =   -90
   ClientTop       =   315
   ClientWidth     =   12060
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Height          =   855
         Left            =   3720
         Picture         =   "frmBankpaymentModification.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   7440
         Width           =   1095
      ...
      Begin VB.CommandButton cmdBack 
         ...
         Height          =   855
         Left            =   5880
         Picture         =   "frmBankpaymentModification.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   7440
         Width           =   1095
      ...
      Begin VB.CommandButton cmdClear 
         ...
         Height          =   855
         Left            =   4800
         Picture         =   "frmBankpaymentModification.frx":0884
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   7440
         Width           =   1095
      ...
      Begin VB.CommandButton cmdModify 
         ...
         Height          =   855
         Left            =   2640
         Picture         =   "frmBankpaymentModification.frx":0CC6
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   7440
         Width           =   1095
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   855
         Left            =   6960
         Picture         =   "frmBankpaymentModification.frx":1108
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   7440
         Width           =   1095
   ...
   End
End
Attribute VB_Name = "frmBankPaymentModification"
...
X = MsgBox("Do You Want to Modify Bank Payment Voucher No." & Val(lstVoucNo), vbInformation + vbYesNo, "Confirm")
...
If ValidateData = True Then
   ...
   Sqlqry = "Update BPmt_Mas set TDATE=#" & Format(txtdate.TextWithMask, "dd/mm/yyyy") & "#," & _
   ...
   Sqlqry1 = "Delete * from BPmt_Tra where vouc_no=" & Val(lstVoucNo) & " "
   ws.BeginTrans
   db.Execute Sqlqry1
   ws.CommitTrans
   ...
   With MSFlexGrid1
     ...
     For B = 1 To a - 1
      ...
      .Col = 3
       ...
       Sqlqry2 = "Insert into BPmt_Tra values(" & Val(lstVoucNo.Text) & ",'BPT','" _
  ...
  MsgBox " Bank Payment Voucher is modified"
  textclear
  Flexitems
  lstVoucNo.SetFocus
 End If
...
Private Sub CmdPrint_Click()
 Dim ctype
   ...
   If ctype = "DHS" Then
        ...
        CrystalReport1.ReportFileName = App.Path & "\BpmtVou.rpt"
        CrystalReport1.SelectionFormula = "{BPmt_Tra.Vouc_no}=" & Val(lstVoucNo.Text) & ""
...
Set ws = DBEngine.Workspaces(0)
Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
Sqlqry = "Select * from BPmt_Mas where status='N' ORDER BY VOUC_NO"
Set rs = db.OpenRecordset(Sqlqry, dbOpenDynaset)
lstVoucNo.Clear
If rs.RecordCount <> 0 Then
   rs.MoveFirst
...
Dim U
    ...
    i = Val(lstVoucNo.Text)
        ...
        Sqlqry = " Select * from BPmt_Mas Where Vouc_no= " & i
        Set rs = db.OpenRecordset(Sqlqry, dbOpenDynaset)
         If rs.RecordCount <> 0 Then
         ...
         Sqlqry1 = "Select * from BPmt_Tra where Vouc_no= " & i
         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
         If rs1.RecordCount = 0 Then
