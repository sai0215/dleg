...
Begin VB.Form frmCashBalRepusd 
   BackColor       =   &H00FFFFC0&
   Caption         =   "Cash  Report - USD"
   ClientHeight    =   8175
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11850
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdDisplay 
         ...
         Height          =   855
         Left            =   1440
         Picture         =   "frmCashBalRepusd.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   2640
         Width           =   1095
      ...
      Begin VB.CommandButton cmdBack 
         ...
         Height          =   855
         Left            =   3600
         Picture         =   "frmCashBalRepusd.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   2640
         Width           =   1095
      ...
      Begin VB.CommandButton cmdclear 
         ...
         Height          =   855
         Left            =   2520
         Picture         =   "frmCashBalRepusd.frx":0884
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   2640
         Width           =   1095
   ...
   End
End
Attribute VB_Name = "frmCashBalRepusd"
...
Opbrpt = 0
       ...
       ' Op. from Account Master
        Sqlqry = " select * from acct_mas where acct_name='CASH IN HAND - USD' "
        Set rs = db.OpenRecordset(Sqlqry, dbOpenDynaset)
        If rs.RecordCount = 0 Then
          MsgBox " Description CASH IN HAND - USD not found"
          Exit Sub
        Else
          rs.MoveFirst
   ...
   '''     ' Total Amount of Sales before From date
     ...
     '   If IsNull(rs1.Fields(0)) = False Then opsal = rs1.Fields(0)
        ...
        Sqlqry2 = "select sum(tra_amount) from capr_mas where Cash_Code ='" & rs!acct_code & "' and tcurrency='USD' and tdate< #" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "#"
       ...
       ' Total cash Receipts before From date
        Sqlqry3 = "select sum(tra_amount) from crpt_mas where Cash_Code ='" & rs!acct_code & "' and tcurrency='USD' and  tdate<#" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "#"
        ...
        Sqlqry4 = "select sum(tra_amount) from cpmt_mas where Cash_Code ='" & rs!acct_code & "'and tcurrency='USD' and  tdate<#" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "#"
        ...
        Sqlqry14 = "select sum(tra_damount) from Jrnl_tra where Acct_Code ='" & rs!acct_code & "' and tcurrency='USD' and tdate<#" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "# and dc_code ='D'"
       ...
       ' Journal Credit Amount before From Date
        Sqlqry15 = "select sum(tra_camount) from Jrnl_tra where Acct_Code ='" & rs!acct_code & "' and tcurrency='USD' and  tdate<#" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "# and dc_code ='C'"
        ...
        sqlqry16 = "select sum(tra_amount) from bpmt_tra where Acct_Code ='" & rs!acct_code & "' and tcurrency='USD' and  tdate<#" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "#"
        ...
        sqlqry17 = "select sum(tra_amount) from brpt_tra where Acct_Code ='" & rs!acct_code & "' and tcurrency='USD' and  tdate<#" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "#"
        ...
        Sqlqry8 = "select * from capr_mas where Cash_Code ='" & rs!acct_code & "' and tcurrency='USD' and tdate>= #" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "# and tdate<=#" & DateValue(Format(txtdateto.TextWithMask, "dd/mm/yyyy")) & "#"
        ...
        Sqlqry10 = "select * from crpt_mas where Cash_Code ='" & rs!acct_code & "' and tcurrency='USD' and  tdate>= #" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "# and tdate<=#" & DateValue(Format(txtdateto.TextWithMask, "dd/mm/yyyy")) & "#"
        ...
        SQLQRY12 = "select * from cpmt_mas where Cash_Code ='" & rs!acct_code & "' and tcurrency='USD' and  tdate>= #" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "# and tdate<=#" & DateValue(Format(txtdateto.TextWithMask, "dd/mm/yyyy")) & "#"
       ...
       ' Bank Payments after From date and before to date
        sqlqry17 = "select * from bpmt_tra where acct_Code ='" & rs!acct_code & "' and tcurrency='USD' and  tdate>= #" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "# and tdate<=#" & DateValue(Format(txtdateto.TextWithMask, "dd/mm/yyyy")) & "#"
        ...
        sqlqry19 = "select * from brpt_tra where acct_Code ='" & rs!acct_code & "' and tcurrency='USD' and  tdate>= #" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "# and tdate<=#" & DateValue(Format(txtdateto.TextWithMask, "dd/mm/yyyy")) & "#"
        ...
        sqlqry16 = "select * from jrnl_tra where Acct_Code ='" & rs!acct_code & "' and tcurrency='USD' and  tdate>= #" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "# and tdate<=#" & DateValue(Format(txtdateto.TextWithMask, "dd/mm/yyyy")) & "# and dc_code='D' "
        Set rs11 = db.OpenRecordset(sqlqry16, dbOpenDynaset)
        ...
        sqlqry18 = "select * from Jrnl_tra where Acct_Code ='" & rs!acct_code & "' and tcurrency='USD' and tdate>= #" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "# and tdate<=#" & DateValue(Format(txtdateto.TextWithMask, "dd/mm/yyyy")) & "# and dc_code='C'"
