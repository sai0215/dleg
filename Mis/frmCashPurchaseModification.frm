...
Begin VB.Form frmCashPurchaseModifcation 
   BackColor       =   &H00FFFFC0&
   Caption         =   "Cash Purchase Modification"
   ClientHeight    =   8775
   ClientLeft      =   -15
   ClientTop       =   330
   ClientWidth     =   12060
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdModify 
         ...
         Height          =   855
         Left            =   3240
         Picture         =   "frmCashPurchaseModification.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   44
         Top             =   7320
         Width           =   975
      ...
      Begin VB.CommandButton cmdClear 
         ...
         Height          =   855
         Left            =   4200
         Picture         =   "frmCashPurchaseModification.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   7320
         Width           =   975
      ...
      Begin VB.CommandButton cmdBack 
         ...
         Height          =   855
         Left            =   5160
         Picture         =   "frmCashPurchaseModification.frx":0884
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   7320
         Width           =   975
      ...
      Begin VB.CommandButton CmdPrint 
         ...
         Height          =   855
         Left            =   6120
         Picture         =   "frmCashPurchaseModification.frx":0CC6
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   7320
         Width           =   975
   ...
   End
End
Attribute VB_Name = "frmCashPurchaseModifcation"
...
Dim qty, rat, amt
 ...
 If Val(txtTtlAmount.Text) = Val(lblgrAmount.Caption) Then
      ...
      If ValidateData = True Then
             ...
             If X = vbYes Then
             Sqlqry = " Update capr_mas set Acct_Code='" & Mid(lstSaleType, 1, 6) & "'," & _
                                             ...
                                             " Cust_no = '" & Mid(CboCustSupp, 1, 4) & "'," & _
                                             " Cust_name = '" & Mid(CboCustSupp, 8, 25) & "'," & _
                                             ...
                                             " Amountdhs = " & totdhs & ", " & _
                                             " Amountusd = " & totusd & ", " & _
                                             " Cash_Code='" & accode & "' where vouc_no =" & Val(lstVoucNo.Text) & ""
               ws.BeginTrans
               db.Execute (Sqlqry)
               ws.CommitTrans
            
               Sqlqry = " Delete * from capr_tra where vouc_no=" & Val(lstVoucNo) & ""
               ws.BeginTrans
               db.Execute Sqlqry
               ws.CommitTrans
               ...
               With MSFlexGrid1
                ...
                For B = 1 To a - 1
                 ...
                 Sqlqry1 = "Insert into capr_tra values('" & Val(lstVoucNo) & "','" _
...
Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
 i = Val(lstVoucNo.Text)
  Sqlqry = "Select * from capr_mas where Vouc_no=" & i & ""
  Set rs = db.OpenRecordset(Sqlqry, dbOpenDynaset)
   If rs.RecordCount <> 0 Then
    ...
    CboCustSupp.Text = rs!cust_no & " : " & rs!cust_name
    ...
    txtbilldate1.TextWithMask = rs!billdate_1
    If IsNull(rs!billdate_2) = True Then
      txtbilldate2.TextWithMask = ""
    Else
      txtbilldate2.TextWithMask = rs!billdate_2
    End If
     
    If IsNull(rs!billdate_3) = True Then
      txtbilldate3.TextWithMask = ""
    Else
      txtbilldate3.TextWithMask = rs!billdate_3
    End If
    
      
    Flexitems
    Sqlqry1 = "Select * from capr_tra where Vouc_no=" & i & " Order by Vouc_no"
    Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
     If rs1.RecordCount = 0 Then
     ...
     rs1.MoveFirst
      Do Until rs1.EOF
        Sqlqry2 = " Insert into DUMCAPR1 values('" & lstVoucNo & "','" _
                              & rs1!tDate & "','" _
                              & rs1!it_code & "','" _
   ...
   i = MsgBox(" Are you sure .. ! You want to Remove this transaction", vbInformation + vbYesNo)
    If i = vbYes Then
     With MSFlexGrid1
        ...
        Sqlqry1 = "Delete * from dumcapr1 where it_Code='" & txtcode & "' and it_desc ='" & txtdesc & "' and it_qty= " & txtQuantity & " and it_rate=" & Val(txtRate) & " and tra_amount =" & Val(txtAmount) & ""
        ws.BeginTrans
        db.Execute Sqlqry1
        ws.CommitTrans
...
Private Sub populatelistvoucno()
 Set ws = DBEngine.Workspaces(0)
 Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
 Sqlqry = "Select Vouc_No from capr_mas where status='N' order by vouc_no"
  Set rs = db.OpenRecordset(Sqlqry, dbOpenDynaset)
   lstVoucNo.Clear
...
Dim con As Currency
 ...
 If ValidateData = True Then
    ...
    Set rs = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
    If rs.RecordCount = 0 Then
        Sqlqry = " Insert into DUMCAPR1 values('" & lstVoucNo & "','" _
                              & Format(txtdate.TextWithMask, "dd/mm/yyyy") & "','" _
                              & Trim(txtcode) & "','" _
