...
Begin VB.Form frmCashReceiptModification 
   BackColor       =   &H00FFFFC0&
   Caption         =   "Cash Receipt Modification"
   ClientHeight    =   8175
   ClientLeft      =   75
   ClientTop       =   345
   ClientWidth     =   11850
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Left            =   4080
         MaskColor       =   &H0080C0FF&
         Picture         =   "frmCashReceiptModification.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   7320
         Width           =   1095
      ...
      Begin VB.CommandButton cmdBack 
         ...
         Left            =   6240
         MaskColor       =   &H0080C0FF&
         Picture         =   "frmCashReceiptModification.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   7320
         Width           =   1095
      ...
      Begin VB.CommandButton cmdClear 
         ...
         Left            =   5160
         MaskColor       =   &H0080C0FF&
         Picture         =   "frmCashReceiptModification.frx":0884
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   7320
         Width           =   1095
      ...
      Begin VB.CommandButton cmdModify 
         ...
         Left            =   3000
         MaskColor       =   &H0080C0FF&
         Picture         =   "frmCashReceiptModification.frx":0CC6
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   7320
         Width           =   1095
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Left            =   7320
         MaskColor       =   &H0080C0FF&
         Picture         =   "frmCashReceiptModification.frx":1108
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   7320
         Width           =   1095
   ...
   End
End
Attribute VB_Name = "frmCashReceiptModification"
...
X = MsgBox("Do You Want to Modify cash Receipt Voucher No." & Val(lstVoucNo), vbInformation + vbYesNo, "Confirm")
...
If ValidateData = True Then
   ...
   Sqlqry = "Update crpt_mas set TDATE=#" & Format(txtdate.TextWithMask, "dd/mm/yyyy") & "#," & _
                            " Recd_from ='" & UCase(Trim(txtPaidTo)) & "'," & _
                            " description='" & findfirstfixup(UCase(Trim(txtTtlDesc))) & "'," & _
                            " Tcurrency='" & Trim(cboCurrency) & "'," & _
                            " Tconvertion=" & con & "," & _
                            " Tra_amount=" & Val(Trim(txtTtlAmount)) & "," & _
                            " TTl_Amount =" & Val(txtTtlAmount) * con & "," & _
                            " Cash_code ='" & Val(cod) & "' Where VOUC_NO = " & Val(lstVoucNo.Text) & " ;"
   ws.BeginTrans
   db.Execute Sqlqry
   ws.CommitTrans
 
   Sqlqry1 = "Delete * from crpt_tra where vouc_no=" & Val(lstVoucNo) & " "
   ws.BeginTrans
   db.Execute Sqlqry1
   ws.CommitTrans
   ...
   With MSFlexGrid1
     ...
     For B = 1 To a - 1
      ...
      .Col = 3
       ...
       Sqlqry2 = "Insert into crpt_tra values(" & Val(lstVoucNo.Text) & ",'CRT','" _
  ...
  MsgBox " Cash Receipt Voucher is modified"
  textclear
  Flexitems
...
Private Sub CmdPrint_Click()
 Dim ctype As String
   ...
   If ctype = "DHS" Then
        ...
        CrystalReport1.SelectionFormula = "{crpt_tra.Vouc_no}=" & Val(lstVoucNo.Text) & ""
...
Set ws = DBEngine.Workspaces(0)
Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
Sqlqry = "select * from crpt_mas where status='N' ORDER BY VOUC_NO"
Set rs = db.OpenRecordset(Sqlqry, dbOpenDynaset)
lstVoucNo.Clear
If rs.RecordCount <> 0 Then
...
Dim U
    ...
    i = Val(lstVoucNo.Text)
        ...
        Sqlqry = " Select * from crpt_mas Where Vouc_no= " & i
        Set rs = db.OpenRecordset(Sqlqry, dbOpenDynaset)
         If rs.RecordCount <> 0 Then
           ...
           txtPaidTo = rs!Recd_From
           txtTtlDesc = rs!Description
           lblTtlAmount.Caption = 0
           
          End If
         
         Sqlqry1 = "Select * from crpt_tra where Vouc_no= " & i
