...
Begin VB.Form frmCinRepScMonFinal 
   BackColor       =   &H00FFFFFF&
   ...
   Begin VB.Frame FraMain 
      ...
      Begin VB.Frame Fradatesel 
         ...
         Begin VB.CommandButton cmddtprint 
            ...
            Height          =   735
            Left            =   360
            Picture         =   "frmCinRepScMonrevfinal.frx":0000
            Style           =   1  'Graphical
            TabIndex        =   9
            Top             =   240
            Width           =   1815
         ...
         Begin VB.CommandButton CmdDtback 
            ...
            Height          =   735
            Left            =   3960
            Picture         =   "frmCinRepScMonrevfinal.frx":0442
            Style           =   1  'Graphical
            TabIndex        =   8
            Top             =   240
            Width           =   1935
         ...
         Begin VB.CommandButton cmddtClear 
            ...
            Height          =   735
            Left            =   2160
            Picture         =   "frmCinRepScMonrevfinal.frx":0884
            Style           =   1  'Graphical
            TabIndex        =   7
            Top             =   240
            Width           =   1815
      ...
      Begin VB.Frame Fradate 
         ...
         Begin VB.CommandButton cmddtgg 
            ...
            Height          =   735
            Left            =   4320
            Picture         =   "frmCinRepScMonrevfinal.frx":0CC6
            Style           =   1  'Graphical
            TabIndex        =   15
            Top             =   3240
            Width           =   1095
         ...
         Begin VB.CommandButton cmddtg 
            ...
            Height          =   735
            Left            =   4320
            Picture         =   "frmCinRepScMonrevfinal.frx":1108
            Style           =   1  'Graphical
            TabIndex        =   12
            Top             =   2400
            Width           =   1095
         ...
         Begin VB.CommandButton CmdDtll 
            ...
            Height          =   735
            Left            =   4320
            Picture         =   "frmCinRepScMonrevfinal.frx":154A
            Style           =   1  'Graphical
            TabIndex        =   11
            Top             =   4920
            Width           =   1095
         ...
         Begin VB.CommandButton cmddtl 
            ...
            Height          =   735
            Left            =   4320
            Picture         =   "frmCinRepScMonrevfinal.frx":198C
            Style           =   1  'Graphical
            TabIndex        =   10
            Top             =   4080
            Width           =   1095
   ...
   End
End
Attribute VB_Name = "frmCinRepScMonFinal"
...
Private Sub CmdDtprint_Click()
   ...
   ws.CommitTrans
    ...
    Else
        Set ws = DBEngine.Workspaces(0)
        Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
        Sqlqry1 = "Select * from cinema_rates where region='" & Trim(cboregion) & "'"
        'Sqlqry1 = "Select * from bo_mas where region='" & Trim(cboregion) & "' and Media='Cinema' and status='N' "
        Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
        If rs1.RecordCount <> 0 Then
        rs1.MoveFirst
        Do Until rs1.EOF
             Sqlqry = "Select * from Bo_tracin where Sub_media='" & rs1!sub_media & "'"
             Set rs = db.OpenRecordset(Sqlqry, dbOpenDynaset)
          '   MsgBox Sqlqry
             If rs.RecordCount <> 0 Then
              rs.MoveFirst
