...
Begin VB.Form frmCinRepScreenMonitor 
   BackColor       =   &H00FFFFC0&
   ...
   Begin VB.Frame FraMain 
      ...
      Begin VB.Frame Fradatesel 
         ...
         Begin VB.CommandButton cmddtprint 
            ...
            Height          =   735
            Left            =   360
            Picture         =   "frmCinRepScreenMonitor.frx":0000
            Style           =   1  'Graphical
            TabIndex        =   9
            Top             =   240
            Width           =   1815
         ...
         Begin VB.CommandButton CmdDtback 
            ...
            Height          =   735
            Left            =   3960
            Picture         =   "frmCinRepScreenMonitor.frx":0442
            Style           =   1  'Graphical
            TabIndex        =   8
            Top             =   240
            Width           =   1935
         ...
         Begin VB.CommandButton cmddtClear 
            ...
            Height          =   735
            Left            =   2160
            Picture         =   "frmCinRepScreenMonitor.frx":0884
            Style           =   1  'Graphical
            TabIndex        =   7
            Top             =   240
            Width           =   1815
      ...
      Begin VB.Frame Fradate 
         ...
         Begin VB.CommandButton cmddtgg 
            ...
            Height          =   735
            Left            =   4320
            Picture         =   "frmCinRepScreenMonitor.frx":0CC6
            Style           =   1  'Graphical
            TabIndex        =   15
            Top             =   3240
            Width           =   1095
         ...
         Begin VB.CommandButton cmddtg 
            ...
            Height          =   735
            Left            =   4320
            Picture         =   "frmCinRepScreenMonitor.frx":1108
            Style           =   1  'Graphical
            TabIndex        =   12
            Top             =   2400
            Width           =   1095
         ...
         Begin VB.CommandButton CmdDtll 
            ...
            Height          =   735
            Left            =   4320
            Picture         =   "frmCinRepScreenMonitor.frx":154A
            Style           =   1  'Graphical
            TabIndex        =   11
            Top             =   4920
            Width           =   1095
         ...
         Begin VB.CommandButton cmddtl 
            ...
            Height          =   735
            Left            =   4320
            Picture         =   "frmCinRepScreenMonitor.frx":198C
            Style           =   1  'Graphical
            TabIndex        =   10
            Top             =   4080
            Width           =   1095
   ...
   End
End
Attribute VB_Name = "frmCinRepScreenMonitor"
...
Private Sub CmdDtprint_Click()
   ...
   ws.CommitTrans
     ...
     If CboRegion = "All" Then
        Set ws = DBEngine.Workspaces(0)
        Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
        Sqlqry1 = "Select * from bo_mas where Media='Cinema'"
               ...
               Set rs2 = db.OpenRecordset(Sqlqry2, dbOpenDynaset)
                     ...
                     If rs2.RecordCount <> 0 Then
                      ...
                      Do Until rs2.EOF
                         ...
                         FMDT = Format(rs2!Datefrom, "dd/mm/yyyy")
                         TODT = Format(rs2!Dateto, "dd/mm/yyyy")
                         
                               Set ws = DBEngine.Workspaces(0)
                               Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
                               'Sqlqry = "select * from dumbo_tracinbo where datefrom=#" & FD & "# or dateto=#" & FD & "# and # " & FD & " # between #" & Format(FMDT, "MM-DD-YYYY") & " # and #" & Format(TODT, "MM-DD-YYYY") & "# "
                               Sqlqry = "select * from dumbo_tracinbo where # " & Format(FD, "dd-mm-yyyy") & " # between #" & Format(FMDT, "DD-mm-YYYY") & " # and #" & Format(TODT, "DD-mm-YYYY") & "# "
                               Set rs = db.OpenRecordset(Sqlqry, dbOpenDynaset)
                              ' MsgBox Sqlqry
                                ...
                                If rs.RecordCount <> 0 Then
                                  ...
                                  Set ws = DBEngine.Workspaces(0)
                                  Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
                                  Sqlqry1 = " Insert into dumbo_trascreen values('" & rs!serial_no & "',#" & FD & "#,'" & rs!Year & "','" _
                                                      & Trim(rs!Month) & "','" _
                                                      & findfirstfixup(rs!Product) & "','" _
                                                      & findfirstfixup(rs!client) & "','" _
                                                      & findfirstfixup(rs!Agency) & "','" & Trim(rs!media) & "','" _
                                                      & Trim(rs!sub_media) & "',#" _
                                                      & Format(rs!Datefrom, "mm/dd/yyyy") & "#,#" _
                                                      & Format(rs!Dateto, "mm/dd/yyyy") & "#,'" _
                                                      & findfirstfixup(Trim(rs!bo_ref)) & "','" _
                                                      & Trim(rs!Day) & "'," _
                                                      & Val(rs!Length) & ",'" _
                                                      & findfirstfixup(Trim(rs!Description)) & "','" _
