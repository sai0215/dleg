...
Begin VB.Form frmCreditNoteModORg 
   BackColor       =   &H00FFFFC0&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CmdModify 
         ...
         Height          =   825
         Left            =   3600
         Picture         =   "frmCreditNoteModOrg.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   7080
         Width           =   1215
      ...
      Begin VB.CommandButton cmdClear 
         ...
         Height          =   825
         Left            =   4800
         Picture         =   "frmCreditNoteModOrg.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   7080
         Width           =   1215
      ...
      Begin VB.CommandButton cmdBack 
         ...
         Height          =   825
         Left            =   6000
         Picture         =   "frmCreditNoteModOrg.frx":0884
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   7080
         Width           =   1215
   ...
   End
End
Attribute VB_Name = "frmCreditNoteModORg"
...
Private Sub Cmdmodify_Click()
 If ValidateData = True Then
    ...
    Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
       Sqlqry = " Update Crdt_MasOrg set tdate=#" & Format(txtdate.TextWithMask, "dd/mm/yyyy") & "#," & _
  ...
  If X = vbYes Then
   ...
   CrystalReport1.SelectionFormula = "{Crdt_MasOrg.Vouc_no}=" & Val(lstVoucNo.Text) & ""
...
Private Sub PopulateVoucher()
 Set ws = DBEngine.Workspaces(0)
 Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
 Sqlqry = "Select Vouc_No from Crdt_MasOrg where status='N' order by vouc_no"
...
Private Sub lstVoucNo_LostFocus()
    ...
    i = Val(lstVoucNo.Text)
        ...
        Sqlqry = " Select * from Crdt_MasOrg Where Vouc_no= " & i
        Set rs = db.OpenRecordset(Sqlqry, dbOpenDynaset)
         If rs.RecordCount <> 0 Then
