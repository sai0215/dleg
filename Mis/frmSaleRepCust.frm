...
Begin VB.Form frmSaleRepCust 
   BackColor       =   &H00FFFFC0&
   Caption         =   "Sales Report - Agency Wise"
   ClientHeight    =   8775
   ClientLeft      =   -45
   ClientTop       =   330
   ClientWidth     =   11985
   ...
   Begin VB.Frame Frame1 
      BackColor       =   &H00FFFFC0&
      Caption         =   "Invoice List - Agency Wise"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmSaleRepCust"
  ...
  If ValidateData = True Then
    ...
    Set db = ws.OpenDatabase(App.Path & "\misov.mdb")
     Sqlqry = " Delete * from invrep"
        ...
        db.Execute (Sqlqry)
        ws.CommitTrans
        Sqlqry1 = "Select * from bo_mas where Invoice_date>= #" & DateValue(Format(txtdatefrom.TextWithMask, "dd/mm/yyyy")) & "# and Invoice_date<=#" & DateValue(Format(txtdateto.TextWithMask, "dd/mm/yyyy")) & "# and agency='" & Trim(lstCustomers) & "' and status='N'"
     ...
     .ReportFileName = App.Path & "\InvrepAgn.rpt"
