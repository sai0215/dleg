...
Begin VB.Form frmTOTANALYSISgr 
   BackColor       =   &H00FFFFC0&
   ...
   End
End
Attribute VB_Name = "frmTOTANALYSISgr"
...
Private Sub PopulateDhs()
 ...
 totper = 0
                      ...
                      '  Sub Media  Alam Assayarat
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and sub_media='ALAM ASSAYARRAT' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyaalam = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and sub_media='ALAM ASSAYARRAT' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyaalam = dcyaalam + Val(rs1.Fields(0) * convertion)
                         
                         
                      '  Sub Media  ZEINA
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and sub_media='ZEINA' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyazeina = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and sub_media='ZEINA' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyazeina = dcyazeina + Val(rs1.Fields(0) * convertion)
                         
                       '  Sub Media  ALAM ASSAAT
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and sub_media='ALAM ASSAAT' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyaaawm = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and sub_media='ALAM ASSAAT' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyaaawm = dcyaaawm + Val(rs1.Fields(0) * convertion)
                         
                        '  Sub Media  AL Buraq
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and sub_media='AL BURAQ' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyaalburaq = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and sub_media='AL BURAQ' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyaalburaq = dcyaalburaq + Val(rs1.Fields(0) * convertion)
                         
                        '  Sub Media  SOUFRA DAIMEH
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and sub_media='SOUFRA DAIMEH' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyasoufra = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and sub_media='SOUFRA DAIMEH' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyasoufra = dcyasoufra + Val(rs1.Fields(0) * convertion)
                         
                                               
                        '  Sub Media  MADINA
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and sub_media='MADINA' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyamadina = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and sub_media='MADINA' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyamadina = dcyamadina + Val(rs1.Fields(0) * convertion)
                         
                       '  Sub Media  CNN
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and sub_media='CNN' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyacnn = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and sub_media='CNN' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyacnn = dcyacnn + Val(rs1.Fields(0) * convertion)
                        
                      '  Media  Online
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and media='Online' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyaeim = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and media='Online' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyaeim = dcyaeim + Val(rs1.Fields(0) * convertion)
                                              
                                                                                            
                      '  Media  Cinema
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and media='Cinema' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dcyacinema = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) & "' and status='N' and media='Cinema' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                      ...
                      ' Last year Actual
                        ...
                        '  Last year Sub Media  Alam Assayarat
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and sub_media='ALAM ASSAYARRAT' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyaalam = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and sub_media='ALAM ASSAYARRAT' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyaalam = dlyaalam + Val(rs1.Fields(0) * convertion)
                         
                         
                      '  Sub Media  ZEINA
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and sub_media='ZEINA' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyazeina = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and sub_media='ZEINA' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyazeina = dlyazeina + Val(rs1.Fields(0) * convertion)
                         
                       '  Sub Media  ALAM ASSAAT
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and sub_media='ALAM ASSAAT' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyaaawm = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and sub_media='ALAM ASSAAT' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyaaawm = dlyaaawm + Val(rs1.Fields(0) * convertion)
                         
                        '  Sub Media  AL Buraq
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and sub_media='AL BURAQ' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyaalburaq = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and sub_media='AL BURAQ' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyaalburaq = dlyaalburaq + Val(rs1.Fields(0) * convertion)
                         
                         '  Sub Media  SOUFRA DAIMEH
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and sub_media='SOUFRA DAIMEH' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyasoufra = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and sub_media='SOUFRA DAIMEH' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyasoufra = dlyasoufra + Val(rs1.Fields(0) * convertion)
                         
                                               
                        '  Sub Media  MADINA
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and sub_media='MADINA' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyamadina = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and sub_media='MADINA' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyamadina = dlyamadina + Val(rs1.Fields(0) * convertion)
                         
                       '  Sub Media  CNN
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and sub_media='CNN' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyacnn = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and sub_media='CNN' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyacnn = dlyacnn + Val(rs1.Fields(0) * convertion)
                        
                      '  Media  Online
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and media='Online' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyaeim = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and media='Online' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyaeim = dlyaeim + Val(rs1.Fields(0) * convertion)
                                              
                                                                                            
                      '  Media  Cinema
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and media='Cinema' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='DHS'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
                         If IsNull(rs1.Fields(0)) = False Then dlyacinema = rs1.Fields(0)
                         
                         Sqlqry1 = " select sum(tra_gamount) from bo_mas where year ='" & Val(Cboyear.Text) - 1 & "' and status='N' and media='Cinema' and Agency ='" & findfirstfixup(Trim(rs!AGENTNAME)) & "' and Tcurrency='USD'"
                         Set rs1 = db.OpenRecordset(Sqlqry1, dbOpenDynaset)
