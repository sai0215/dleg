...
Begin VB.Form frmBOModol 
   BackColor       =   &H00FFFFFF&
   Caption         =   "BOModificationOl"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   ...
   Begin VB.CommandButton cmdModify 
      BackColor       =   &H00C0FFC0&
      Caption         =   "&Modify"
      DisabledPicture =   "frmBOModOl.frx":0748
      DownPicture     =   "frmBOModOl.frx":0C7A
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
...
Sqlqry = "Select * from Bo_Mas where status='N' and media='Online' ORDER BY val(Serial_NO)"
